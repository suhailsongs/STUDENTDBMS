...
namespace StudentDBMS
{
    ...
    class student
    {
        ...
        public static void AddRecord()
        {
            ...
            try
            {
                if (File.Exists("C:/Users/student/Desktop/SDetails.txt"))
                {
                    sw = new StreamWriter(new FileStream("C:/Users/student/Desktop/SDetails.txt", FileMode.Append, FileAccess.Write));
                }
                else
                {
                    sw = new StreamWriter(new FileStream("C:/Users/student/Desktop/SDetails.txt", FileMode.OpenOrCreate, FileAccess.ReadWrite));
                }
            }
            catch (IOException)
            {
        ...
        public static void ShowAll()
        {
            ...
            try
            {
                br = new StreamReader(new FileStream("C:/Users/student/Desktop/SDetails.txt", FileMode.Open));
